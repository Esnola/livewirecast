...
?>
<div>
  <form wire:submit="save" class="w-96 space-y-6" action="{{ route('product.img_upload') }}" method="POST" enctype="multipart/form-data">
    <flux:input wire:model="name" label="Title" placeholder="Title" class="w-full"/>
    <flux:textarea wire:model="description" label="Content" placeholder="Write here..." class="w-full"/>
